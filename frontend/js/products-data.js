const productsDatabase = [
    ...
    },
    {
        ...
        rating: 4,
        ratingCount: 0,
        description: "پرچمدار سامسونگ با هوش مصنوعی Galaxy AI و دوربین 200 مگاپیکسل",
        specs: {
            "صفحه نمایش": "6.8 اینچ Dynamic AMOLED 2X 120Hz",
            "رم": "12 گیگابایت",
            "حافظه داخلی": "512 گیگابایت",
            "دوربین": "200 مگاپیکسل + قلم S-Pen"
        }
    },
    {
        id: 27,
        ...
        rating: 5,
        ratingCount: 0,
        description: "قوی‌ترین آیفون با تراشه A17 Pro و تیتانیوم",
        specs: {
            "صفحه نمایش": "6.7 اینچ Super Retina XDR 120Hz",
            "رم": "8 گیگابایت",
            "حافظه داخلی": "256 گیگابایت",
    ...
    },
    {
        ...
        rating: 5,
        ratingCount: 0,
        description: "گوشی با طراحی Glyph LED منحصربه‌فرد و تجربه خالص اندروید",
        specs: {
    ...
    },
    {
        ...
        rating: 5,
        ratingCount: 0,
        description: "هدفون حرفه‌ای نویز کنسلینگ با کیفیت صدای بینظیر",
        specs: {
            "نوع": "روی گوشی",
            "نویز کنسلینگ": "فعال + Adaptive",
            "باتری": "40 ساعت"
    ...
    },
    {
        ...
        rating: 4,
        ratingCount: 0,
        description: "هدفون پرچمدار اپل با طراحی لوکس و کیفیت صدای استثنایی",
        specs: {
            "نوع": "روی گوشی",
            "تراشه": "Apple H1",
            "باتری": "20 ساعت"
    ...
    },
    {
        ...
        rating: 5,
        ratingCount: 0,
        description: "لپ تاپ گیمینگ فوق‌العاده قدرتمند با پردازنده Ryzen 9 و RTX 4070",
        specs: {
            "پردازنده": "AMD Ryzen 9 7940HS",
            "رم": "32 گیگابایت",
            "کارت گرافیک": "NVIDIA RTX 4070",
            "صفحه نمایش": "14 اینچ QHD 165Hz"
        }
    },
    {
        id: 32,
        name: "لپ تاپ اپل MacBook Pro 14 M3 Pro",
        category: "laptop",
        price: 418440000,
        oldPrice: 502128000,
        image: "macbookpro14m3.jpg",
        stock: 3,
        rating: 5,
        ratingCount: 0,
        description: "لپ تاپ حرفه‌ای با تراشه M3 Pro و نمایشگر Liquid Retina XDR",
        specs: {
    ...
    },
    {
        ...
        rating: 4,
        ratingCount: 0,
        description: "لپ تاپ فوق‌باریک با نمایشگر InfinityEdge OLED 4K",
        specs: {
            "پردازنده": "Intel Core i7-13700H",
            "رم": "16 گیگابایت",
            "حافظه داخلی": "512 گیگابایت SSD",
            "صفحه نمایش": "15.6 اینچ OLED 4K"
        }
    },
    {
        id: 34,
        name: "ساعت هوشمند سامسونگ Galaxy Watch 6 Classic",
        category: "accessory",
        price: 66570000,
        oldPrice: 79884000,
        image: "galaxywatch6classic.jpg",
        stock: 15,
        rating: 5,
        ratingCount: 0,
        description: "ساعت هوشمند با صفحه چرخان و نمایشگر Super AMOLED",
        specs: {
            "صفحه نمایش": "1.47 اینچ Super AMOLED",
            "باتری": "425 میلی‌آمپر",
            "سیستم عامل": "Wear OS"
        }
    },
    {
        id: 35,
        name: "کنسول بازی پلی استیشن 5 Slim",
        category: "gaming",
        price: 95100000,
        oldPrice: 114120000,
        image: "ps5slim.jpg",
        ...
        rating: 0,
        ratingCount: 0,
        description: "کنسول بازی نسل نهم با SSD فوق‌سریع و کنترلر DualSense",
        specs: {
            "حافظه داخلی": "1TB SSD",
            "رزولوشن": "تا 4K 120Hz",
            "کنترلر": "DualSense بی‌سیم"
        }
    },
    {
        id: 36,
        name: "کنسول بازی نینتندو سوییچ OLED",
        category: "gaming",
        price: 66570000,
        oldPrice: 79884000,
        ...
        rating: 5,
        ratingCount: 0,
        description: "کنسول بازی قابل حمل با نمایشگر OLED 7 اینچی",
        specs: {
            "صفحه نمایش": "7 اینچ OLED",
    ...
    {
        id: 37,
        name: "جاروبرقی دایسون V15 Detect",
        category: "home",
        price: 142650000,
        oldPrice: 171180000,
        image: "dysonv15.jpg",
        ...
        rating: 5,
        ratingCount: 0,
        description: "جاروبرقی بی‌سیم با سنسور لیزری و نمایشگر LCD",
        specs: {
            "نوع": "بی‌سیم",
            "توان": "660 وات",
            "مدت کار": "60 دقیقه",
            "فناوری": "Laser Slim Fluffy"
        }
    },
    {
        id: 38,
        name: "هدفون سامسونگ Galaxy Buds2 Pro",
        category: "accessory",
        price: 32334000,
        oldPrice: 38800800,
        image: "buds2pro.jpg",
        ...
        rating: 5,
        ratingCount: 0,
        description: "هدفون بی‌سیم با نویز کنسلینگ و صدای 24bit Hi-Fi",
        specs: {
            "نوع": "درون گوشی",
            "نویز کنسلینگ": "فعال",
            "باتری": "29 ساعت"
    ...
    },
    {
        ...
        rating: 5,
        ratingCount: 0,
        description: "تبلت قدرتمند با تراشه M2 و طراحی فوق‌باریک",
        specs: {
            "صفحه نمایش": "11 اینچ Liquid Retina",
            "تراشه": "Apple M2",
            "حافظه داخلی": "256 گیگابایت"
        }
    },
    {
        id: 40,
        name: "دوربین گوپرو Hero 12 Black",
        category: "camera",
        price: 76080000,
        oldPrice: 91296000,
        image: "gopro12.jpg",
        ...
        rating: 5,
        ratingCount: 0,
        description: "دوربین اکشن حرفه‌ای با فیلمبرداری 5.3K و تثبیت‌کننده HyperSmooth 6.0",
        specs: {
            "رزولوشن": "5.3K تا 60fps",
            "تثبیت‌کننده": "HyperSmooth 6.0",
            "ضد آب": "تا 10 متر"
        }
    },
    {
        id: 41,
        name: "تلویزیون ال جی C3 OLED 65 اینچ",
        category: "tv",
        price: 342360000,
        oldPrice: 410832000,
        image: "lgc3oled.jpg",
        ...
        rating: 0,
        ratingCount: 0,
        description: "تلویزیون OLED با پردازنده α9 Gen6 و پشتیبانی از Dolby Vision",
        specs: {
            "صفحه نمایش": "65 اینچ OLED evo",
            "رزولوشن": "4K 120Hz",
            "پردازنده": "α9 Gen6 AI"
        }
    },
    {
        id: 42,
        name: "موس گیمینگ لاجیتک G Pro X Superlight 2",
        category: "gaming",
        price: 30432000,
        oldPrice: 36518400,
        image: "gproxsuperlight2.jpg",
        stock: 18,
        rating: 5,
        ratingCount: 0,
        description: "موس حرفه‌ای گیمینگ با وزن 60 گرم و سنسور Hero 2",
        specs: {
            "نوع": "بی‌سیم",
            "سنسور": "Hero 2",
            "وزن": "60 گرم",
    ...
    },
    {
        ...
        rating: 5,
        ratingCount: 0,
        description: "مانیتور گیمینگ 4K با نرخ تازه‌سازی 144Hz و Mini LED",
        specs: {
            "صفحه نمایش": "32 اینچ VA Mini LED",
            "رزولوشن": "4K UHD",
            "نرخ تازه‌سازی": "144Hz"
        }
    },
    {
        id: 44,
        name: "هدفون سونی WF-1000XM5",
        category: "accessory",
        price: 53256000,
        oldPrice: 63907200,
        image: "sonywf1000xm5.jpg",
        stock: 13,
        rating: 5,
        ratingCount: 0,
        description: "هدفون بی‌سیم حرفه‌ای با نویز کنسلینگ پیشرفته",
        specs: {
            "نوع": "درون گوشی",
            "نویز کنسلینگ": "فعال + Adaptive",
            "باتری": "24 ساعت"
    ...
    {
        id: 45,
        name: "کیبورد مکانیکی کی‌کرون Q1 Pro",
        category: "gaming",
        price: 38040000,
        oldPrice: 45648000,
        image: "keychronq1pro.jpg",
        stock: 16,
        rating: 5,
        ratingCount: 0,
        description: "کیبورد مکانیکی 75% با بدنه آلومینیومی و اتصال بی‌سیم",
        specs: {
            "نوع": "75% مکانیکی",
            "اتصال": "بی‌سیم + USB-C",
            "سوئیچ": "Gateron Jupiter"
        }
    }
];
