...
// ============================================================
// شمارش بر اساس IP واقعی کاربر انجام می‌شود. keyGenerator پیش‌فرض
// خودِ کتابخانه آدرس‌های IPv6 را درست نرمال‌سازی می‌کند، بنابراین
// نسخه سفارشی تعریف نمی‌کنیم تا امکان دور زدن محدودیت با IPv6 نباشد.
